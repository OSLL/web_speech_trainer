...
from .number_slides.criterion import NumberSlidesCriterion
from .number_word_on_slide.criterion import NumberWordOnSlideCriterion
...
from .intonation_stability.criterion import IntonationStabilityCriterion